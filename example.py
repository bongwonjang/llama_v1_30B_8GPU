...
def load(
    ...
    #######################################################
    # e.g) MP=4
    # Not only intra-layer model parallelism, we use inter-layer parallelism
    # |              intra-layer             |  
    #                        |  inter-layer  |
    # Process [rank 0]    =>   cuda:0, cuda:1
    # Process [rank 1]    =>   cuda:2, cuda:3
    # Process [rank 2]    =>   cuda:4, cuda:5
    # Process [rank 3]    =>   cuda:5, cuda:6
    ...
    model = Transformer(model_args, first_device, second_device)
